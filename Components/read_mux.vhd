...
ARCHITECTURE SYN OF read_mux IS
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL read_mux.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL read_mux.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL read_mux.cmp FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL read_mux.bsf TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL read_mux_inst.vhd FALSE
